@echo off
title KLING AI - Generador de Videos con IA + Sistema de Creditos
color 0A
cls
...
echo  ╔════════════════════════════════════════════════════════════╗
echo  ║                                                            ║
echo  ║          KLING AI - GENERADOR DE VIDEOS CON IA            ║
echo  ║                  [MODO TODO EN UNO]                       ║
echo  ║                                                            ║
echo  ║          ✨ NUEVO: Sistema de Creditos Integrado          ║
echo  ║                                                            ║
echo  ╚════════════════════════════════════════════════════════════╝
echo.
